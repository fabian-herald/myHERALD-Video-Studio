...
const PREAMBLE = [
  ...
  "Read CRAFT.md too: the size floors, the layer model and the easing meanings the visual",
  "review holds you to. Advisory — where it seems to disagree with the contract, the",
  "contract wins, and it grants no licence to move more than CONTRACT §6a allows.",
